...
class BaseModel(object):
    ...
    def _get_learning_rate_decay(self, hparams):
        ...
        print(' decay_scheme={}, start_decay_step={}, decay_steps {},
              decay_factor {}'.format(
    ...
    def _build_decoder(self, encoder_outputs, encoder_state, hparams):
        ...
        # Maximum iteration (max decoding steps)
...
class Model(BaseModel):
    ...
    def _build_bidirectional_rnn(self, inputs, sequence_length,
        ...
        bi_outputs, bi_state = tn.nn.bidirectional_dynamic_rnn(
            fw_cell,
            bw_cell,
            inputs,
            dtype=dtype,
    ...
    def _build_decoder_cell(self, hparams, encoder_outputs, encoder_state,
        ...
        if hparams.attention:
            raise ValueError('BasicModel doesnt support attention.')
        ...
        # For beam search, we must replicate encoder infos beam_width times
